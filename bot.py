    ...
    if usr_cmd == "/start":
        ...
        try:
            ...
            await send_stored_file.reply_text(
                f"**Link yang anda gunakan :** https://t.me/{Config.BOT_USERNAME}?start=VideoViralHot_{file_id}\n\n__Jika ingin melihat video, buka dengan link !__",
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == "private":
        ...
        try:
            ...
            share_link = f"https://t.me/{Config.BOT_USERNAME}?start=VideoViralHot_{file_er_id}"
            await editable.edit(
